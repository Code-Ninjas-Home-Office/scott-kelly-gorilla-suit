...
scott_kelly_imgs=github:Code-Ninjas-Home-Office/scott_kelly_imgs
```
...
"main.ts": "\n",
"pxt.json": "{\n "name": "scott-kelly-json",\n "description": "",\n "dependencies": {\n "device": ""\n },\n "files": [\n "main.blocks",\n "main.ts",\n "README.md",\n "assets.json",\n "tilemap.g.jres",\n "tilemap.g.ts",\n "images.g.jres",\n "images.g.ts",\n "pxt.json"\n ],\n "targetVersions": {\n "branch": "v1.12.56",\n "tag": "v1.12.56",\n "commits": "https://github.com/microsoft/pxt-arcade/commits/415ef2df2ac233e8d214fef5f4ea26f2f5de232a\",\n "target": "1.12.56",\n "pxt": "8.5.67"\n },\n "preferredEditor": "blocksprj"\n}\n",
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Crew, function (sprite, otherSprite) {
    if (sprite.image.equals(assets.image`gorillasuitRight`) || sprite.image.equals(assets.image`gorillasuitLeft`)) {
    }
})
